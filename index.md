...
<div class="section">
  ...
  <div class="grid-2">
    ...
    <div class="card">
      ...
      <p>PyTorch, TensorFlow, Keras, CNN Modeling, Training Optimization, BatchNorm, Dropout, EarlyStopping</p>
    </div>

    <div class="card">
      <div class="card-title">NLP & LLMs</div>
      <p>LangChain, Hugging Face, FAISS, Embeddings, RAG, AI Agents, Retrieval Pipelines, Prompt Design, Grounded Evaluation</p>
    </div>

    <div class="card">
      <div class="card-title">Computer Vision</div>
      <p>OpenCV, Mask R-CNN, Object Detection, Image Segmentation, Satellite Imagery Analysis</p>
    </div>
